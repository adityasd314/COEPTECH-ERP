...
function HeroSection() {
  return (
    <HeroHighlight className="h-[50rem] w-full dark:bg-grid-black/[0.2] bg-grid-black/[0.2] bg-gray-300 text-black relative flex flex-col md:flex-row items-center justify-center">
      ...
      <div className="w-full bg-opacity-50 backdrop-blur-lg dark:bg-opacity-60 dark:bg-gray-600 dark:border-gray-600 rounded-lg shadow-md md:mt-0 sm:max-w-md xl:p-0">          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
