...
function App() {
  ...
  console.log(userP);
  console.log(userP);
  if (userP == null || userP == 'null' || userP == 'undefined') {
  ...
  return (
    <>
      ...
      <Chatbot
        mess={
          "Hello, I am COEP's Venue Booking Systems Assistant. How may I help you?"
        }
        initialPrompt={
          "'Act as a COEP's Venue Booking Systems Assistan and respond to this query: '"
        }
        data={venues}
      />
    </>
